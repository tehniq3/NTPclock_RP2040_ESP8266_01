...
byte pornire = 1;  // force read good clock first time
...
if (liber0 != liber)
{
  ...
  if (pornire != 1)  // just if clock info are ok
  {
  ...
  {
    tpNTP = millis()+2000;  // retry after 2 seconds
    //delay(2000); 
    liber = 1;
  }

...
char ssid[] = "niq_ro's network ";        // your network SSID (name)
char pass[] = "passw0rd!";        // your network password

#include <ArduinoJson.h>
#define led 25 // onboard led 

char servername[]="api.openweathermap.org";              // remote weather server we will connect to
String APIKEY = "ca5522688e0751dde95c4a4b9a681dce"; // https://home.openweathermap.org/api_keys                            

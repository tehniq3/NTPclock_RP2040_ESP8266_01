...
void loop()
{
  ...
  if (packetSize)
  {
    ...
    unsigned long epoch = secsSince1900 - seventyYears + (timeZone+DST)*3600;  // local time
    // print Unix time:
    Serial.println(epoch);

    // print the hour, minute and second:
    Serial.print(F("The local time is "));       // UTC is the time at Greenwich Meridian (GMT)
